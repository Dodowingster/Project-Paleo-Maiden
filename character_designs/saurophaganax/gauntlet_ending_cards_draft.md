...
- Career True Route is only available if the player's Maiden reaches MAX
  Affinity before the Grand Finals.
- In the Career route, Saurophaganax reveals that the Lecturer has been
  caught in the loop as well, repeatedly returning to train different Maidens
  while forgetting prior cycles after each reset.
- Gauntlet Mode is the post-career space where that truth is answered in full:
  Saurophaganax expects the Maiden to return with a decision, and the Lecturer
  is part of that decision because their bond shaped how the Maiden faced the
  truth.

## Mode Flow Rule (Career Run -> Gauntlet)
- In a normal Career Run, Saurophaganax confrontation ends with loop reset and
  career closure.
- Before the reset completes, Saurophaganax taunts the Maiden/player to
  challenge her again "if you seek the truth behind this world."
- Gauntlet Mode is that rematch space: Saurophaganax expects the Maidens to
  return, not just to win, but to present an answer.
- Her tone in Gauntlet should feel like she is addressing both the Maiden and
  the Lecturer as recurring witnesses, even though the Maiden remains the one
  who ultimately chooses the answer.
- Because Gauntlet is a truth-trial space, endings here are written as
  alternative-answer continuities rather than default Career Run outcomes.
...
- Lecturer Influence: Learning that the Lecturer is mind-wiped each cycle transforms Tyran's purpose into chosen sovereignty: she takes the recurrence herself so others can live continuously.
...
- World Result: The Lecturer is no longer trapped in the reset cycle. World continuity proceeds, while Tyran becomes the standing point of repetition against Saurophaganax.
...
- Lecturer presence should influence tone, urgency, and the final choice, but
  should not overwrite the Maiden's identity or final agency.
- Career Run must always hand off into Gauntlet through Saurophaganax's taunt
  invitation to return for the truth.
- Gauntlet endings are alternative continuity answers, not mandatory mainline canon.
