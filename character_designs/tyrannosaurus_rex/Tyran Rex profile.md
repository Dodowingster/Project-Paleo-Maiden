...
| :--- | :--- | :--- |
| **Base** | Warrior | Brute (Core) |
| **Hybrid** | Battlemage | Brute + Stamina |
...
| :--- | :--- | :--- |
| **Warrior** | **Crushing Impact:** Every attack focuses on overwhelming force and dealing massive single-hit damage, leveraging her high **Stamina** pool. | **Tyrant Divider:** A vertical sword slash launched from a ground drag ablazed, ending in a crushing downward impalement that bypasses defense into a massive explosion. |

---

## Motivation and Goals

* **Primary Goal:** To win the PMC by a commanding, record-breaking margin, thereby solidifying her undisputed authority over the entire student body (in her mind, this is leadership by example).
* **Internal Goal:** Believes in herself to inspire others as great fighters for future generations.
