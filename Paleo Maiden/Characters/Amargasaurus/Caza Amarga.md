...
| **Lore Reflection** | As a member of the **Sauropodomorpha** clade, she is a descendant of **Sauris**. Her **Twin-Spine Lash** mirrors the bifurcated neural spines of her species. Her unique movement, **"Tidal Glide,"** allows her to coat the ground in low-friction P-Magic, letting her slide and pivot with minimal physical effort—a nod to the suspected aquatic habits of smaller sauropods. |
...
| **Strengths** | Spatial Control, Analytical Combat, High-Speed Calculus, Ballroom Dance |

| **Weakness** | Perfectionism, Weak against "unpredictable" brawlers, Secretly addicted to street food |
...
| **Likes** | Classical Music, Swimming, Teaching |

| **Dislikes** | Slouching, Wasteful P-Magic usage, "Gutter Language" |
...
| **Base** | **Cadence Warden** | **Control (Core)** |

| **Final** | **Noble Architect** | **Control + Focus** |
...
| **Cadence Warden** | **Tidal Glide:** Caza coats the ground in fluid P-Magic, allowing her to "skate" effortlessly. This grants her perfect control over her momentum and range. She focuses on depleting the opponent's P-Magic through constant, rhythmic lashes while she remains untouched. | **Crescendo Lash:** A multi-stage whip combo performed while sliding at high speed. The momentum of her "glide" is channeled into the twin whip-heads, creating a series of sonic snaps that drain P-Magic on contact. |

| **Noble Architect** | **Abyssal Mastery:** Fusing Control with **Focus (Blue)**, Caza turns the "fluid floor" into a weapon. She can create P-Magic whirlpools that drag opponents toward her or "freeze" the fluid into jagged ice-like spikes to restrict movement further. | **Amarga’s Final Lesson:** Traps the opponent in a "Whirlpool of Light." As the P-Magic lashes tighten with the weight of the deep ocean, she delivers a "Noble Burst" that simulates total sensory decompression, resulting in immediate exhaustion. |
