...
> ⚠ **ANOMALY CLASSIFICATION — NOT A REGISTERED PALEO MAIDEN**

> Saurophaganax Maximus is not a product of natural Deinos manifestation.

> She does not belong to any Family Clade. She holds no affiliation,

> no league standing, and no lineage record. Her existence violates the

> foundational rules of the Paleo Maiden world. This profile exists

> as a containment document, not a character registration.
...
| **Species** | *Saurophaganax maximus* (Meaning: "Greatest King of the Lizard-Eaters") |

| **Era** | Late Jurassic (Morrison Formation) |

| **Key Features** | Nomen dubium — a disputed fossil whose classification has never been formally resolved. The specimen is a chimeric reconstruction, assembled from fragmented remains that paleontologists believe may belong to multiple different animals, including misidentified Allosaurus bones. It should not exist as a single species. It may not. |

| **Lore Reflection** | Her entire existence mirrors her fossil record: contradictory, unresolved, and assembled from pieces that do not belong together. She is the only Paleo Maiden whose real-life counterpart is itself an anomaly — a creature that science cannot fully classify or confirm. This is not coincidence. It is the point. |
...
Saurophaganax Maximus is not born. She is not manifested. She is accumulated.

  

The deep, unresolved tension between the Saurischian and Ornithischian lineages — the eternal inheritance of the Sauris and Ornith divide — does not simply exist as history. It generates pressure. Over centuries of rivalry, clashing P-Magic, contested blood, and unresolved conflict between the two great orders, that pressure condenses. What emerges from it should not be possible: a Paleo Maiden formed not from a single species lineage, but from the residue of two irreconcilable ones.

  

She is what happens when the classification system fails completely.

  

The original Sauris and Ornith Maidens recognized her for what she was and

sealed her together at the same moment. That synchronized seal prevented the

lineage conflict from cascading into time reversion at the time of first

containment. The seal holds — until it does not. Her return is not a matter

of if. It is a matter of when the world's accumulated lineage friction reaches

a breaking point again. She is cyclical by nature. The world does not produce

her. The world's own contradictions do.
...
| **Lineage Origin** | Saurischian / Ornithischian conflict residue (chimeric) |
...
| Character | Relationship Type | Nature |
...
| **Lecturer (Player)** | The Universal Constant | She recognizes the Professor as the inevitable cosmic position of the mentor across the multiverse. Regardless of the timeline, personality, or training discipline, a Professor always steps forward to guide a Paleo Maiden to the apex. She taunts them to "seek the true conviction of their bond," knowing that unless an absolute, multiversal harmonic resonance is reached by these distinct mentors, the system will default to another timeline iteration. |
...
## Combat Forms (Phase Structure)

  

> *She does not have a vocation. She has escalation states.*

  

| Phase | Form Title | Combat Character |
...
| Phase | Core Principle | Signature Behavior |
...
* Her name does not follow the standard Paleo Maiden naming convention of [Species] [Genus]. *Saurophaganax maximus* inverts it — genus first, species qualifier second — because she predates the convention. She existed before the system was built to contain her.

* She is the only entity in the Paleo Maiden world who can identify what a Primal Instinct aura-form represents. Every other Maiden feels only awe or terror at the shape. Saurophaganax sees the species. She watched them go extinct.

* The real-world *Saurophaganax maximus* specimen has been debated since its discovery in 1941. Many paleontologists consider it an oversized *Allosaurus fragilis* rather than a distinct genus. The specimen remains formally unresolved. She is, in the most literal sense, a creature that science cannot decide actually exists.